...
function BookmarkList({ bookmarkTitle }) {
  return (
    <BookmarkContainer>
        <BackIcon loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/8a5c6e224a78addfb6dfdd81623a41bf80539dc36492c8744900ebc91120e359?placeholderIfAbsent=true&apiKey=a4eaf54e67064b758783ed5c744d50de" alt="Bookmark icon" />
