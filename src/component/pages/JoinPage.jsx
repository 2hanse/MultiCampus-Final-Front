...
const JoinPage = () => {
  ...
  const checkEmail = useCallback(
    async (e) => {
      e.preventDefault();
      try {
        const response = await api.post('/users/email-exists', {
          email: email,
        });
        if (response.data) {
  ...
  const checkNickName = useCallback(
    async (e) => {
      e.preventDefault();
      try {
        const response = await api.post('/users/nickname-exists', {
          nickName: nickName,
        });
        if (response.data) {
    ...
    <StyledForm onSubmit={onSubmit}>
      ...
      <main>
        ...
        <StyledInputField>
          ...
          />
          <StyledButton small type="button" onClick={handleVerificationRequest}>
            인증
          </StyledButton>
        </StyledInputField>
        <Formbox>
