...
const UnfollowConfirmation = ({ username, closeModal }) => {
  const buttons = [
    { text: '예', action: () => closeModal(true) }, // 예 버튼: 언팔로우 상태로 변경
  ...
  return (
    <>
      ...
      <section className="unfollow-confirmation">
        <div className="confirmation-dialog">
          <p className="confirmation-message">{username} 님을 언팔로우 하시겠습니까?</p>
